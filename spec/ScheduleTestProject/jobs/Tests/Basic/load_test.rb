...
ENV['OT_CUSTOM_ZENITH_VERSION'] ||= 'freshly_built'
TEST_VERSION_OF_DLL = ENV['OT_CUSTOM_ZENITH_VERSION'].to_sym || raise('fuck')

class LoadTest < OtScheduleTestCase
  ...
  def test_simple
    ...
    # @tr.scheduleStartTime = 410 # This is 6:50AM @timePeriods.first
    ...
    assert_equal(10, @db.get_value('link5_2data1', [1,1,'Walk',tt(400),1,1,1,1,0], 'load'), 'walk access')
    assert_equal(10, @db.get_value('link5_2data1', [2,1,'PT',  tt(420),1,1,1,1,1], 'load'), 'walk access')
    assert_equal(10, @db.get_value('link5_2data1', [6,1,'PT',  tt(426),1,1,1,1,1], 'load'), 'walk access')
    assert_equal(10, @db.get_value('link5_2data1', [7,1,'PT',  tt(431),1,1,1,2,1], 'load'), 'walk access')
    assert_equal(10, @db.get_value('link5_2data1', [4,1,'PT',  tt(436),1,1,1,1,1], 'load'), 'walk access')
    assert_equal(10, @db.get_value('link5_2data1', [5,1,'Walk',tt(450),1,1,1,2,0], 'load'), 'walk egress')
    ...
    assert_in_delta(6, @db.get_value('link5_2data1', [1,1,'Walk',tt(400),1,1,1,1,0], 'cost'), TEST_DELTA, 'walk access cost')
    assert_in_delta(30.0 / 4, @db.get_value('link5_2data1', [2,1,'PT',  tt(420),1,1,1,1,1], 'cost'), TEST_DELTA, 'pt leg cost')
    assert_in_delta(30.0 / 4, @db.get_value('link5_2data1', [6,1,'PT',  tt(426),1,1,1,1,1], 'cost'), TEST_DELTA, 'pt leg cost')
    assert_in_delta(30.0 / 4, @db.get_value('link5_2data1', [7,1,'PT',  tt(431),1,1,1,2,1], 'cost'), TEST_DELTA, 'pt leg cost')
    assert_in_delta(30.0 / 4, @db.get_value('link5_2data1', [4,1,'PT',  tt(436),1,1,1,1,1], 'cost'), TEST_DELTA, 'pt leg cost')
    assert_in_delta(6, @db.get_value('link5_2data1', [5,1,'Walk',tt(450),1,1,1,2,0], 'cost'), TEST_DELTA, 'walk egress cost')
  ...
  # end
  #
  # def t est_multip le_od_matrices
