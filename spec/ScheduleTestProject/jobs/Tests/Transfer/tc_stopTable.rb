...
class TC_stopTable < OtTestCase
  ...
  def test_simple
    ...
    assert_in_delta(10,          @db.get_value('stop5_3data1', [1,1,'PT' ,10060,1,1,1,3,0,0,1], "firstboarding"),  0.01, "boardings")
    ...
    assert_in_delta(10*usage[0], @db.get_value('stop5_3data1', [2,1,'Bus',10070,1,1,1,3,0,4,0], "changeboarding"), 0.01, "changing 3->4")
    assert_in_delta(10*usage[1], @db.get_value('stop5_3data1', [2,1,'PT' ,10075,1,1,1,3,0,5,0], "changeboarding"), 0.01, "changing 3->5")
    assert_in_delta(10*usage[0], @db.get_value('stop5_3data1', [4,1,'Bus',10080,1,1,1,4,0,0,2], "lastalighting"),  0.01, "changing 3->4")
    assert_in_delta(10*usage[1], @db.get_value('stop5_3data1', [4,1,'PT' ,10078,1,1,1,5,0,0,2], "lastalighting"),  0.01, "changing 3->5")
  end
