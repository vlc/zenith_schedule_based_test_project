...
class TC_stopTable < OtScheduleTestCase
  ...
  def test_simple
    ...
    assert_in_delta(10*usage[0], @db.get_value('link5_2data1', [6,1,'Bus',t(70),1,1,1,1,4], "load"), 0.01, "more expensive path")
    assert_in_delta(10*usage[1], @db.get_value('link5_2data1', [6,1,'PT', t(75),1,1,1,1,5], "load"), 0.01, "cheaper path")

    assert_in_delta(10,          @db.get_value('stop5_3data1', [1,1,'PT' ,t(60),1,1,1,3,0,0,1], "firstboarding"),  0.01, "boardings")
    ...
    assert_in_delta(10*usage[0], @db.get_value('stop5_3data1', [2,1,'Bus',t(70),1,1,1,3,0,4,0], "changeboarding"), 0.01, "changing 3->4")
    assert_in_delta(10*usage[1], @db.get_value('stop5_3data1', [2,1,'PT' ,t(75),1,1,1,3,0,5,0], "changeboarding"), 0.01, "changing 3->5")
    assert_in_delta(10*usage[0], @db.get_value('stop5_3data1', [4,1,'Bus',t(80),1,1,1,4,0,0,2], "lastalighting"),  0.01, "changing 3->4")
    assert_in_delta(10*usage[1], @db.get_value('stop5_3data1', [4,1,'PT' ,t(78),1,1,1,5,0,0,2], "lastalighting"),  0.01, "changing 3->5")
  end
  ...
  #    assert_in_delta(10,          @db.get_value('stop5_2data1', [1,1,'PT' ,t(60),1,1,1,3,1], "firstboarding"), 0.01, "boardings")
  #    assert_in_delta(10*usage[0], @db.get_value('stop5_2data1', [4,1,'Bus',t(80),1,1,1,4,2], "lastalighting"), 0.01, "alighting from 4")
  #    assert_in_delta(10*usage[1], @db.get_value('stop5_2data1', [4,1,'PT' ,t(78),1,1,1,5,2], "lastalighting"), 0.01, "alighting from 5")
  #  }
  #end
